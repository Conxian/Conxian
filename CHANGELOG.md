...
- **Security & Testing Documentation**: Added API, security review, and testing framework docs, and wired them into the CI/CD workflow.
...
- **Clarity Error-Handling Alignment**: Normalized response and error types, `asserts!` usage, and `try!`/`unwrap!` patterns across governance, pools, lending, automation, enterprise, and math contracts.
