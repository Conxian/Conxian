...
(use-trait cxlp-migration-queue-trait .cxlp-migration-queue-trait.cxlp-migration-queue-trait)
(use-trait ft-mintable .sip-010-ft-mintable-trait.sip-010-ft-mintable-trait)
