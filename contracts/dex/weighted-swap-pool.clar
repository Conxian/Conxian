...
;; 50%(define-data-var weight-y uint u50000000) 
...
;; Simplified power function using integer math  (if (is-eq exp u100000000) base    (if (is-eq exp u0) u100000000        (/ (* base exp) u100000000)        (* base (/ exp u100000000))      )    )  ))