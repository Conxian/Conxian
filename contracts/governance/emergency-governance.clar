...
;; Timelock settings
(define-constant EMERGENCY_DELAY u248832000) ;; ~2 minutes for critical actions
(define-constant STANDARD_TIMELOCK_BLOCKS u2073600) ;; ~2.4 hours for standard actions
(define-constant PROPOSAL_EXPIRY_BLOCKS u14515200) ;; ~16.8 hours
