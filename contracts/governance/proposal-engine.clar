...
;; Data Maps(define-map proposals {  proposal-id: uint} {  proposer: principal,  start-block: uint,  end-block: uint,  votes-for: uint,  votes-against: uint,  executed: bool,  details: (string-ascii 256)})
...
(define-data-var voting-period-blocks uint u100) 

;; Example: 100 blocks voting period(define-data-var quorum-percentage uint u5000) 
