...
(define-public (mint
  ...
  (let ((id (var-get last-token-id)))
    (begin
      ...
      (match uri
        some-uri-val (map-set token-uris (+ id u1) (some some-uri-val))
