...
(define-trait dim-registry-trait
  (
    ...
    ;; @returns (response (list 100 principal) uint): A list of the principals of the registered oracles, or an error.
    (get-registered-oracles () (response (list 100 principal) uint))
  )
)
