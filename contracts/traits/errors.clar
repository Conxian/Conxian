...
(define-constant ERR_VOTING_PERIOD_ENDED u6002)       ;; The voting period for the specified proposal has ended.
...
(define-constant ERR_VOTING_DELAY u6006)              ;; The voting delay has not passed.
...
(define-constant ERR_INVALID_DURATION u8009)          ;; The specified duration is invalid.
