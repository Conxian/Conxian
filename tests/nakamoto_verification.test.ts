...
describe('Nakamoto Architecture Verification', () => {
  ...
  it('sBTC Vault: Trustless Wrap', () => {
    ...
    simnet.callPublicFn('sbtc-token', 'mint', [
      Cl.uint(100000000000),
      Cl.contractPrincipal(deployer, 'btc-adapter')
    ], deployer);
    ...
    const wrapFn = simnet.callPublicFn('sbtc-vault', 'wrap-btc', [
      txBlob,
      header,
      proof,
